...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Albums
    Route::apiResource('albums', AlbumController::class)->only(['store', 'update', 'destroy']);
    ...
    // Site Settings
    Route::apiResource('settings', SiteSettingController::class)->only(['store', 'update', 'destroy']);
